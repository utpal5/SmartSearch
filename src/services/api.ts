import { Book, SearchParams, ApiResponse } from '../types/Book';

const BASE_URL = 'https://openlibrary.org';

export const searchBooks = async (params: SearchParams): Promise<ApiResponse> => {
...
export const getCoverUrl = (coverId: number | string, size: 'S' | 'M' | 'L' = 'M'): string => {
  return `https://covers.openlibrary.org/b/id/${coverId}-${size}.jpg`;
};

export const getBookDetails = async (bookKey: string): Promise<any> => {
